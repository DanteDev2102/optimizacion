...
<!-- FULLSCREEN RESPONSIVE LAYOUT FOR KKT -->
<div class="relative w-full h-full flex flex-col lg:flex-row bg-[#0f131f] p-2 lg:p-4 gap-4 lg:gap-8 overflow-hidden">
  
  <!-- LEFT PANEL: Setup -->
  <div class="w-full lg:w-1/2 h-full flex-col overflow-y-auto custom-scrollbar flex">
    <div class="w-full py-6 lg:py-8 px-4 lg:px-8">
      
      <div class="flex flex-col gap-6">
        <div>
          <h2 class="text-xs font-bold tracking-[0.2em] text-zinc-400 uppercase mb-4">Evaluador KKT Independiente</h2>
        ...
        <!-- Acción -->
        <button onclick={evaluate} class="mt-4 w-full py-4 rounded-2xl bg-gradient-to-r from-teal-400 to-emerald-400 text-black font-bold uppercase tracking-widest flex items-center justify-center gap-2 hover:opacity-90 transition-all shadow-[0_0_30px_rgba(45,212,191,0.3)]">
  ...
  <!-- RIGHT PANEL: Results -->
  <div class="w-full lg:w-1/2 h-full flex-col relative overflow-hidden lg:border-l lg:border-white/5 flex">
