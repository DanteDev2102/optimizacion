        ...
        <div class="flex flex-col gap-4">
          <button onclick={() => sectionsOpen.algorithm = !sectionsOpen.algorithm} class="flex justify-between items-center w-full group">
            <h2 class="flex items-center gap-2 text-xs font-bold tracking-[0.2em] text-zinc-400 uppercase group-hover:text-white transition-colors">
              <Cpu class="w-4 h-4 text-zinc-500 group-hover:text-white transition-colors"/> Algorithm Selection
            </h2>
          ...
          {#if sectionsOpen.algorithm}
            <div transition:slide>
              <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                <button onclick={() => algorithm = 'gradient'} class="flex flex-col gap-1 p-3 rounded-xl border text-left transition-all {algorithm === 'gradient' ? 'bg-teal-500/10 border-teal-500 text-teal-400' : 'bg-[#1e2638] border-transparent text-zinc-400 hover:border-white/10'}">
                  <Activity class="w-6 h-6" />
                  <span class="font-bold text-white text-sm">Gradient Descent</span>
                </button>
                <button onclick={() => algorithm = 'newton'} class="flex flex-col gap-1 p-3 rounded-xl border text-left transition-all {algorithm === 'newton' ? 'bg-teal-500/10 border-teal-500 text-teal-400' : 'bg-[#1e2638] border-transparent text-zinc-400 hover:border-white/10'}">
                  <Target class="w-6 h-6" />
                  <span class="font-bold text-white text-sm">Robust Newton</span>
                </button>
                <button onclick={() => algorithm = 'bfgs'} class="flex flex-col gap-1 p-3 rounded-xl border text-left transition-all {algorithm === 'bfgs' ? 'bg-teal-500/10 border-teal-500 text-teal-400' : 'bg-[#1e2638] border-transparent text-zinc-400 hover:border-white/10'}">
                  <Zap class="w-6 h-6" />
                  <span class="font-bold text-white text-sm">BFGS</span>
                </button>
                <button onclick={() => algorithm = 'dfp'} class="flex flex-col gap-1 p-3 rounded-xl border text-left transition-all {algorithm === 'dfp' ? 'bg-teal-500/10 border-teal-500 text-teal-400' : 'bg-[#1e2638] border-transparent text-zinc-400 hover:border-white/10'}">
                  <Zap class="w-6 h-6 text-blue-400" />
                  <span class="font-bold text-white text-sm">DFP</span>
                </button>
                <button onclick={() => algorithm = 'lbfgs'} class="flex flex-col gap-1 p-3 rounded-xl border text-left transition-all {algorithm === 'lbfgs' ? 'bg-teal-500/10 border-teal-500 text-teal-400' : 'bg-[#1e2638] border-transparent text-zinc-400 hover:border-white/10'}">
                  <Zap class="w-6 h-6 text-purple-400" />
                  <span class="font-bold text-white text-sm">L-BFGS</span>
                </button>
                <button onclick={() => algorithm = 'ga'} class="flex flex-col gap-1 p-3 rounded-xl border text-left transition-all {algorithm === 'ga' ? 'bg-teal-500/10 border-teal-500 text-teal-400' : 'bg-[#1e2638] border-transparent text-zinc-400 hover:border-white/10'}">
                  <Settings class="w-6 h-6" />
                  <span class="font-bold text-white text-sm">Genetic Alg</span>
                </button>
              </div>
            </div>
          {/if}
